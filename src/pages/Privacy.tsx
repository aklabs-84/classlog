          ...
          <section>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5 space-y-3">
              ...
              <ul className="space-y-2 list-disc pl-5 text-blue-700">
                <li>
                  <strong>학생 실명 전송 범위:</strong> 세특/생기부 초안 생성 시 학생의 실명은 AI 모델에 전달되지 않으며,
                  관찰 내용(활동명, 기록 내용)만 익명화하여 전송됩니다. 다만 선생님이 직접 사용하는 AI 대화(채팅) 기능에서는
                  질문에 답하기 위해 해당 학급의 학생 이름이 관찰 기록과 함께 전송될 수 있습니다.
                </li>
                <li>
