        ...
        <div className="space-y-10 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="mt-2 space-y-1 list-disc pl-5">
              ...
              <li><strong>플랜:</strong> 무료(Free)·Pro·School 등 서비스 이용 범위에 따라 구분된 요금제</li>
          ...
          <section>
            <h2 className="text-lg font-black text-gray-900 mb-3">제4조의2 (학생 제출물·협업 화이트보드의 보관 및 자동 삭제)</h2>
            <ul className="mt-2 space-y-1 list-disc pl-5">
              <li>무료 플랜 이용자의 종료된 수업에서 학생이 제출한 결과물(첨부 파일 포함) 및 해당 수업에 연결된 협업 화이트보드(이미지 포함)는 수업 종료일로부터 1개월 뒤 자동 삭제됩니다.</li>
          ...
          <section>
            ...
            <ul className="mt-2 space-y-1 list-disc pl-5">
              <li>무료 플랜은 별도 비용 없이 이용할 수 있으며, Pro·School 플랜은 유료로 제공됩니다.</li>
